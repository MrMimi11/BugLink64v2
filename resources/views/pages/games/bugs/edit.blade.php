...
@section('content')
    ...
    <form action="{{ route('games.bugs.update', [$game->slug, $bug->slug]) }}" method="post"
        ...
        <div class="form-group">
            ...
            <input type="text" name="title" class="form-control" id="title" value="{{ $bug->title }}" autofocus>
        </div>
        @error('title')
        ...
        <div class="form-group">
            ...
            <input type="text" name="video" class="form-control" id="video" value="{{ $bug->video }}">
        </div>
        @error('video')
        <span class="text-danger text-sm">{{ $message }}</span>
        @enderror
